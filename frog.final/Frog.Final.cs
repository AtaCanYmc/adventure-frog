                    ...
                    if ((ts2.TotalMilliseconds / 800) >= 1)
                    {
                        ...
                        for (int moves = 0; moves < allCars.Length; moves++) //type-1 moves
                        {
                            ...
                            if (allCarSpeeds[moves] == 1 && (allCarY[moves] == 3 || allCarY[moves] == 4))
                            {
                                ...
                                {
                                    for (int controlTheRoad = 0; controlTheRoad < allCarLengths[moves]; controlTheRoad++)
                                    {
                                        for (int innerControlTheRoad = 0; innerControlTheRoad < 12; innerControlTheRoad++)
                                        {
                                            if ((road1[52 - controlTheRoad] == allCarX[innerControlTheRoad] && (allCarY[moves] == 4)) && road1[0] == allCarX[innerControlTheRoad])
                                            { allCarY[moves] = rastgele.Next(3, 5); }
                                            if ((road2[52 - controlTheRoad] == allCarX[innerControlTheRoad] && (allCarY[moves] == 3)) && road2[0] == allCarX[innerControlTheRoad])
                                            { allCarY[moves] = rastgele.Next(3, 5); }
                                        }
                                    }
                                    allCarX[moves] = 54;
                            ...
                            if (allCarSpeeds[moves] == 1 && (allCarY[moves] == 5 || allCarY[moves] == 6))
                            {
                                if (allCarX[moves] == 54)//Road-end control
                                {
                                    for (int controlTheRoad = 0; controlTheRoad < allCarLengths[moves]; controlTheRoad++)
                                    {
                                        for (int innerControlTheRoad = 12; innerControlTheRoad < 24; innerControlTheRoad++)
                                        {
                                            if ((road3[1 + controlTheRoad] == allCarX[innerControlTheRoad] && (allCarY[moves] == 5)) && road4[54] == allCarX[innerControlTheRoad])
                                            { allCarY[moves] = rastgele.Next(5, 7); }
                                            if ((road4[1 + controlTheRoad] == allCarX[innerControlTheRoad] && (allCarY[moves] == 6)) && road4[54] == allCarX[innerControlTheRoad])
                                            { allCarY[moves] = rastgele.Next(5, 7); }
                                        }
                                    }
                                    allCarX[moves] = 1;
                            ...
                            for (int crush2 = 0; crush2 < allCars.Length; crush2++)
                            {
                                ...
                                if (((crush != crush2) && (allCarY[crush] == allCarY[crush2])))
                                {
                                    if ((allCarY[crush] == 3 || allCarY[crush] == 4) && ((allCarX[crush]) == (allCarX[crush2] + allCarLengths[crush2]))) //CONTROL FOR ROAD 1 AND 2
                                    {
                                        if ((allCarY[crush] == 3))
                                        {
                                            for (int controllerR2 = 0; controllerR2 < (allCarLengths[crush] + 2); controllerR2++) //İS OTHER ROAD EMPTY?
                                            {
                                                if ((road2[(allCarX[crush] - 1 + controllerR2)] == '1') || (road2[(allCarX[crush] - 1 + controllerR2)] == '2'))
                                                { roadcontrol1 = true; }
                                        ...
                                        if ((allCarY[crush] == 4))
                                        {
                                            for (int controllerR2 = 0; controllerR2 < (allCarLengths[crush] + 2); controllerR2++) //İS OTHER ROAD EMPTY?
                                            {
                                                if ((road1[(allCarX[crush] - 1 + controllerR2)] == '1') || (road1[(allCarX[crush] - 1 + controllerR2)] == '2'))
                                                { roadcontrol2 = true; }
                                    ...
                                    else if ((allCarY[crush] == 5 || allCarY[crush] == 6) && ((allCarX[crush2]) == (allCarX[crush] + allCarLengths[crush]))) //CONTROL FOR ROAD 3 AND 4
                                    {
                                        if ((allCarY[crush] == 5))
                                        {
                                            for (int controllerR2 = 0; controllerR2 < (allCarLengths[crush] + 2); controllerR2++) //İS OTHER ROAD EMPTY?
                                            {
                                                if ((road4[(allCarX[crush] - 1 + controllerR2)] == '1') || (road4[(allCarX[crush] - 1 + controllerR2)] == '2'))
                                                { roadcontrol3 = true; }
                                        ...
                                        if ((allCarY[crush] == 6))
                                        {
                                            for (int controllerR2 = 0; controllerR2 < (allCarLengths[crush] + 2); controllerR2++) //İS OTHER ROAD EMPTY?
                                            {
                                                if ((road3[(allCarX[crush] - 1 + controllerR2)] == '1') || (road3[(allCarX[crush] - 1 + controllerR2)] == '2'))
                                                { roadcontrol4 = true; }
